/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a8a38722240b3726b2c22c523b53f33d)
// Runtime types generated with workerd@1.20250927.0 2025-03-21 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../excalidraw-backend/src/index");
		durableNamespaces: "ExcalidrawWebSocketServer";
	}
	interface Env {
		DURABLE_OBJECT: DurableObjectNamespace<import("../excalidraw-backend/src/index").ExcalidrawWebSocketServer>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
